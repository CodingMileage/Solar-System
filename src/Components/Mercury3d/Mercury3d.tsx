  ...
  return (
    <>
      <div className="container">
        ...
        <ul>
          <li className="mercTemp">Temperature: {temp - 273} C</li>
          <li className="mercMass">
            Mass: {mass} X 10^{massE}
          </li>
          <li className="mercEV">Escape Velocity: {escape} m/s</li>
          <li className="mMoon">Moons: {moons}</li>
          <li className="mercDays">Sideral Days: {Math.round(days)}</li>
        </ul>
      </div>
      <div className="mCard">
