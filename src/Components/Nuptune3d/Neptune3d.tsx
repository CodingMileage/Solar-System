  ...
  return (
    <>
      <div className="container">
        ...
        <ul>
          <li className="nepTemp">Temperature: {temp - 273} C</li>
          <li className="nepMass">
            Mass: {mass} X 10^{massE}
          </li>
          <li className="nepEV">Escape Velocity: {escape} m/s</li>
          <li className="nepMoon">Moons: {moons}</li>
          <li className="nepDays">Sideral Days: {Math.round(days)}</li>
        </ul>
      </div>
